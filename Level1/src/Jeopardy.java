...
public class Jeopardy implements ActionListener {
	...
	private void start() {
		...
		frame.setTitle("Jeperdie");
		
		// 3. Create a JPanel variable to hold the header using the createHeader method
		JPanel panel = createHeader("panel");
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		if(buttonPressed.equals(firstButton)){
			askQuestion("How do you spell Jeopardy?", "Jeperdie", 200);
		}else if(buttonPressed.equals(secondButton)){
			askQuestion("Did you get this question correct?", "yes", 800);
		}else if(buttonPressed.equals(thirdButton)){
			askQuestion("What color is a mirror?", "green", 400);
		}else if(buttonPressed.equals(fourthButton)){
			askQuestion("What are you?", "bad at jeopardy", 600);
		}
